        ...
        <div className="shop-cta-container">
          <div className="shop-cta-card">
            <div className="shop-cta-content">
              <h3 className="shop-cta-title">{t('needHelp', 'Need Help Choosing?')}</h3>
              <p className="shop-cta-description">
                {t('shopCtaDescription', 'Our experts are here to help you find the perfect equipment for your game.')}
              </p>
              <button className="shop-cta-btn">
                <span>{t('getAdvice', 'Get Expert Advice')}</span>
                <div className="shop-cta-btn-glow"></div>
              </button>
            </div>
          </div>
        </div>
